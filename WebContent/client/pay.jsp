...
<body>
    ...
    <form action="${pageContext.request.contextPath}/onlinepay"
        method="post">
        Order ID<INPUT TYPE="text" NAME="orderid" value="${param.id}">
        Payment:<INPUT TYPE="text" NAME="money" value="${param.money}">元
        <div class="divBank">
            <div class="divText">select online bank</div>
            <div style="margin-left: 20px;">
                <div style="margin-bottom: 20px;">
                    ...
                    align="middle" src="<c:url value='/client/bank_img/cmb.bmp'/>" />
                    <input
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    id="BOCO-NET-B2C" type="radio" name="yh" value="BOCO-NETB2C"
                    />
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    id="HKBEA-NET-B2C" type="radio" name="yh" value="HKBEA-NETB2C"
                    />
                    <img name="HKBEA-NET-B2C" align="middle"
                        src="<c:url value='/client/bank_img/dy.bmp'/>" /> <input
                    id="NBCB-NET-B2C" type="radio" name="yh" value="NBCB-NETB2C"
                    />
                    <img name="NBCB-NET-B2C" align="middle"
                        src="<c:url value='/client/bank_img/ningbo.bmp'/>" /> <input
                    id="ECITIC-NET-B2C" type="radio" name="yh" value="ECITIC-NETB2C"
                    />
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    id="SPDB-NET-B2C" type="radio" name="yh" value="SPDB-NETB2C"
                    />
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    id="BJRCB-NET-B2C" type="radio" name="yh" value="BJRCB-NETB2C"
                    />
                    <img name="BJRCB-NET-B2C" align="middle"
                        src="<c:url value='/client/bank_img/beijingnongshang.bmp'/>" />
                    <input
                        id="HXB-NET-B2C" type="radio" name="yh" value="HXB-NET-B2C" />
                    <img
                        name="HXB-NET-B2C" align="middle"
                        src="<c:url value='/client/bank_img/hx.bmp'/>" /> 
                    <input id="CZNET-B2C"
