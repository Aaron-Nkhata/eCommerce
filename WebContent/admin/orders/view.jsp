    ...
    <table cellSpacing="1" cellPadding="5" width="100%" align="center"
        ...
        <tr>
            <td class="ta_01" align="center" bgColor="#afd1f3" colSpan="4"
                height="26"><strong><STRONG>detail information of order</STRONG>
            </strong></td>
        </tr>
        <tr>
            ...
            <td align="center" bgColor="#f5fafe" class="ta_01">user</td>
        ...
        <tr>
            ...
            <td align="center" bgColor="#f5fafe" class="ta_01">telephone</td>
            <td class="ta_01" bgColor="#ffffff">${order.receiverPhone }</td>
        </tr>
        <tr>
            <td align="center" bgColor="#f5fafe" class="ta_01">address</td>
            <td class="ta_01" bgColor="#ffffff">${order.receiverAddress}</td>
            <td align="center" bgColor="#f5fafe" class="ta_01">total price</td>
            <td class="ta_01" bgColor="#ffffff">${order.money }</td>
        </tr>
        <tr>
            <td align="center" bgColor="#f5fafe" class="ta_01">order time</td>
            ...
            <TD class="ta_01" bgColor="#ffffff" colSpan="3">
                <table cellspacing="0" cellpadding="1" rules="all"
                    ...
                    <tr
                        ...
                        <td align="center" width="18%">product ID</td>
                        <td align="center" width="10%">product name</td>
                        <td align="center" width="10%">price</td>
                        <td width="7%" align="center">purchase quantity</td>
                        <td width="7%" align="center">product category</td>
                        <td width="31%" align="center">product description</td>
                    </tr>
        ...
        <TR>
            <td class="ta_01" style="WIDTH: 100%" align="right" bgColor="#f5fafe"
                colSpan="4"><FONT face="Times New Roman">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</FONT>
                <INPUT class="button_ok" type="button" onclick="history.go(-1)" value="return" /> <span id="Label1"></span></td>
        </TR>
    </table>
</body>
</HTML>