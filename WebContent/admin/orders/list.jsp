...
BACKGROUND-COLOR: #afd1f3">
                                ...
                                <td width="11%" align="center">total price</td>
                                <td width="8%" align="center">user</td>
                                <td width="10%" align="center">order status</td>
                                <td width="7%" align="center">browse</td>
                            ...
                            <c:forEach items="${orders}" var="order">
                                <tr onmouseover="this.style.backgroundColor = 'white'"
                                    ...
                                    <td style="CURSOR: hand; HEIGHT: 22px"
                                        ...
                                        ${order.money}</td>
                                    <td width="8%"
                                        align="center">${order.user.username}</td>
                                    <td width="10%"
                                        align="center">${order.paystate==0?"unpaid":"paid"}</td>
                                    <td align="center" style="HEIGHT: 22px"><a
                                        href="${pageContext.request.contextPath}/findOrderById?id=${order.id}&type=admin">
                                        <img
                                            src="${pageContext.request.contextPath}/admin/images/browse_view.gif"
                                    ...
                                    <td align="center" style="HEIGHT: 22px"><c:if
                                        ...
                                        <c:if test="${order.paystate==0 }">
                                            <a href="javascript:alert('Dont delete unpaid order')">
                                                <img
                                                    src="${pageContext.request.contextPath}/admin/images/i_del.gif"
                                                    width="16" height="16" border="0"
                                                    style="CURSOR: hand">
